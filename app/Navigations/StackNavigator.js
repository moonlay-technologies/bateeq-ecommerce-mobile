...
import Pages from '../Screens/Components/PageOurStory';
...
import PagesContactUs from '../Screens/pages/ContactUs';
  ...
  if (isAuthenticated) {
    return (
      ...
      >
        ...
        <StackComponent.Screen name="PageOurStory" component={Pages} />
        <StackComponent.Screen name="ContactUs" component={PagesContactUs} />
