...
function AccordionHighlight() {
  ...
  function AccordionHeader(item, _, isActive) {
    return (
      <View
        style={{
          flexDirection: 'row',
      ...
      >
        ...
        />
        <Text style={[FONTS.font, FONTS.fontMedium, { color: isActive ? COLORS.white : COLORS.title, flex: 1 }]}>
          {item.title}
        </Text>
        <FontAwesome
  ...
  function AccordionBody(item, _, isActive) {
    return (
