...
import DividerIcon from './Dividers/DividerIcon';
        ...
        <View style={GlobalStyleSheet.container}>
          ...
          >
            <View style={GlobalStyleSheet.card}>
              ...
              <DividerIcon
                color={COLORS.danger}
                icon={<FeatherIcon name="alert-circle" color={COLORS.danger} size={18} />}
              />
              <DividerIcon
                color={COLORS.primary}
                icon={<FeatherIcon name="alert-triangle" color={COLORS.primary} size={18} />}
              />
              <DividerIcon
                color={COLORS.secondary}
                icon={<FeatherIcon name="sun" color={COLORS.secondary} size={18} />}
              />
          ...
          >
            <View style={GlobalStyleSheet.card}>
              ...
              <DividerIcon
                dashed
                color={COLORS.info}
                icon={<FeatherIcon name="truck" color={COLORS.info} size={18} />}
              />
              <DividerIcon
                dashed
                color={COLORS.title}
                icon={<FeatherIcon name="settings" color={COLORS.title} size={18} />}
              />
              />
            </View>
          </DropShadow>
