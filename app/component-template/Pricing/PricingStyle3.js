...
function PricingStyle3() {
  ...
  return (
    ...
    >
      ...
      >
        <Text style={{ ...FONTS.h3, lineHeight: 32, color: COLORS.title, opacity: 0.9 }}>$56</Text>
      ...
      <View style={{ marginBottom: 20 }}>
        ...
        <Text style={{ ...FONTS.font, fontSize: 16, color: COLORS.text, lineHeight: 22 }}>
