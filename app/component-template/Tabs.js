...
import TabButtonStyle1 from './Tabs/TabButtonStyle1';
import TabButtonStyle2 from './Tabs/TabButtonStyle2';
        ...
        <View style={GlobalStyleSheet.container}>
          ...
          >
            <View style={GlobalStyleSheet.card}>
              <View
                style={{ borderBottomWidth: 1, borderColor: COLORS.borderColor, paddingBottom: 8, marginBottom: 10 }}
              >
          ...
          >
            <View style={GlobalStyleSheet.card}>
              ...
              <ScrollView
                ...
                decelerationRate="fast"
                showsHorizontalScrollIndicator={false}
                onScroll={Animated.event([{ nativeEvent: { contentOffset: { x: scrollX2 } } }], {
                  useNativeDriver: false,
                })}
              >
                {/* tab 1 */}
