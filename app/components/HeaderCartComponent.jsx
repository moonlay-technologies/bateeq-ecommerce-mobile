...
import MenuListHeader from '../component-template/MenuListHeader';

function HeaderCartComponent({ showMenuItems, dataMenuItems, dataStory }) {
  ...
  return (
    <View>
      ...
      <View>{showMenuItems && <MenuListHeader menuItems={dataMenuItems} dataStory={dataStory} />}</View>
    </View>
  );
}
