						...
						<View style={{flexDirection:"row",alignItems:"center",justifyContent:"space-between"}}>
							<View style={{
							...
							}}>
								{
									...
									Array.isArray(data?.lineItems?.nodes) && data?.lineItems?.nodes.length > 0 &&
								...
								
								{
									...
									data?.lineItems?.nodes.length > 2 && (
										<View style={{
											...
											<Text style={{
												color:"#fff"
											}}>{[data?.lineItems?.nodes.length - 2,"+"].join("")}</Text>
										</View>
									)
								}
							</View>
							<View
								style={{
									flex:1,
									left: (data?.lineItems?.nodes.length ?? 0) > 2 ? -50 : -((((data?.lineItems?.nodes?.length - 1) ?? 2) - 1) * 20),
							...
							>
								...
								<View
									...
									<Text style={{fontSize:12}}>{
										data?.lineItems?.nodes.slice(0,2).map((item)=> item?.title.slice(0,10))
											.join("...")
									}</Text>
								</View>
							</View>
