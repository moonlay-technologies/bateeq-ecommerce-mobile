...
(function (AuthResponseCallback) {
    AuthResponseCallback[AuthResponseCallback["SUCCESS"] = 0] = "SUCCESS";
    AuthResponseCallback[AuthResponseCallback["FAILURE"] = 1] = "FAILURE";
...
class IterableCommerceItem {
    ...
    categories;
    dataFields;
    constructor(id, name, price, quantity, sku, description, url, imageUrl, categories, dataFields) {
        this.id = id;
        this.name = name;
        this.price = price;
...
var EventName;
(function (EventName) {
    EventName["handleUrlCalled"] = "handleUrlCalled";
    EventName["handleCustomActionCalled"] = "handleCustomActionCalled";
    EventName["handleInAppCalled"] = "handleInAppCalled";
    EventName["handleAuthCalled"] = "handleAuthCalled";
    EventName["receivedIterableInboxChanged"] = "receivedIterableInboxChanged";
    EventName["handleAuthSuccessCalled"] = "handleAuthSuccessCalled";
    EventName["handleAuthFailureCalled"] = "handleAuthFailureCalled";
})(EventName || (EventName = {}));
class Iterable {
