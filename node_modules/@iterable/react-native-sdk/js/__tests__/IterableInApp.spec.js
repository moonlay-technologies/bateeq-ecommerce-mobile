...
import { IterableInAppLocation, IterableInAppTrigger, IterableInAppTriggerType, IterableInboxMetadata, IterableInAppCloseSource, IterableInAppShowResponse, IterableInAppDeleteSource } from '../IterableInAppClasses';
...
test('trackInAppOpen_params_methodCalledWithParams', () => {
    ...
    const msg = new IterableInAppMessage('someMessageId', 123, new IterableInAppTrigger(IterableInAppTriggerType.event), new Date(1234), new Date(123123), true, new IterableInboxMetadata('title', 'subtitle', 'iconURL'), { 'CustomPayloadKey': 'CustomPayloadValue' }, false, 300.5);
...
test('trackInAppClose_params_methodCalledWithParams', () => {
    ...
    const msg = new IterableInAppMessage('someMessageId', 123, new IterableInAppTrigger(IterableInAppTriggerType.event), new Date(1234), new Date(123123), true, new IterableInboxMetadata('title', 'subtitle', 'iconURL'), { 'CustomPayloadKey': 'CustomPayloadValue' }, false, 300.5);
    const location = IterableInAppLocation.inbox;
    const source = IterableInAppCloseSource.link;
    const url = 'ClickedURL';
...
test('inAppConsume_params_methodCalledWithParams', () => {
    ...
    const location = IterableInAppLocation.inApp;
    const source = IterableInAppDeleteSource.unknown;
...
test('inAppHandler_messageAndEventEmitted_methodCalledWithMessage', () => {
    ...
    config.inAppHandler = jest.fn((message) => {
